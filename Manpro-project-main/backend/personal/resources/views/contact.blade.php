          ...
          <div class="col-lg-4">
            <div>
              <div class="address">
                ...
                <p style="color: white;">Jl. Selokan Mataram Jl. Pogung Dalangan No.16, RT.11/RW.50</p>
              </div>

              <div class="email">
                <i class="bi bi-envelope"></i>
                <h4 style="color: white;">Email:</h4>
                <p  style="color: white;">wiwtpruamazing@gmail.com</p>
              </div>

              <div class="phone">
                <i class="bi bi-phone"></i>
                <h4 style="color: white;">Whatsapp:</h4>
                <p style="color: white;"> 081392113276</p>
              </div>
