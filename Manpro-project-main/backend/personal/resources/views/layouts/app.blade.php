...
<head>
  ...
  <!-- Favicons -->
  <link href="{{ asset('assets/user/img/wiwit.png') }}" rel="icon">
...
<body>
  ...
  <header id="header" class="fixed-top" style="background-color: black;">
    <div class="container-fluid d-flex justify-content-between align-items-center">
      ...
      <h1 class="logo me-auto me-lg-0"><a href="{{ route('index') }}">Wiwit AB</a></h1>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6 mb-6 mb-md-0">
        ...
        <p style="color:white"><i class="bi bi-telephone-fill m-4"></i> 081392113276</p>
  ...
  <div class="text-center p-3">
    <a style="color:white">Wiji Nurastuti | Wiwit AB @2022</a>
